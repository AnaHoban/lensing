...
#autosave
model_checkpoint_file = "../Models/autoencoder_r_only.h5"
...
#saving model
autoencoder_cfis.save("../Models/autoencoder_r_only")
hist_df = pd.DataFrame(history_cfis.history) 

hist_csv_file = '../Histories/history_r_only.csv'
