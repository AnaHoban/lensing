...
#autosave
model_checkpoint_file = "../Models/autoencoder_128p_job3.h5"
...
#saving model
autoencoder_cfis.save("../Models/autoencoder_cfis_128p_job3")
hist_df = pd.DataFrame(history_cfis.history) 

hist_csv_file = '../Histories/history_cfis_128p_job3.csv'
